...
const _perks = {
    ...
    rail_reload:     { cat:'rail', label:'Rapid Charge',   desc:'RAIL charge time -20% and fire interval -15% (stackable)', apply: () => { _perkState.reloadMult=(_perkState.reloadMult||1)*0.85; } },
