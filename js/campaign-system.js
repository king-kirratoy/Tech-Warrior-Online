...
function showMissionSelect() {
    ...
    html += '<div class="cm-title" style="flex:1 1 auto;min-width:0;">CAMPAIGN</div>';
    ...
    html += `<button onclick="_openShopFromMission()" class="tw-btn tw-btn--ghost tw-btn--sm" style="flex:0 0 auto;width:auto;">Supply Shop</button>`;
