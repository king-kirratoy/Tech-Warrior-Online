...
| `js/constants.js` | All immutable game data: chassis, weapons, shields, augments, legs, cover, arenas, enemy color palettes, restriction Sets, starter loadouts, `SLOT_ID_MAP`, and `GAME_CONFIG`. |
