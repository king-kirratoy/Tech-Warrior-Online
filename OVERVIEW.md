...
Last updated: March 21, 2026 (v5.7 — script tag for js/combat.js added to index.html)
...
**Load order in `<head>`:**
```
constants.js → state.js → audio.js → utils.js → perks.js → combat.js → loot-system.js → enemy-types.js → arena-objectives.js → campaign-system.js → multiplayer.js → inline <script>
```
