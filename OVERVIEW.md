...
Last updated: March 21, 2026 (v5.15 — mech visual system extracted into js/mechs.js)
...
**Load order in `<head>`:**
```
constants.js → state.js → audio.js → utils.js → mechs.js → perks.js → combat.js → mods.js → enemies.js → rounds.js → hud.js → garage.js → menus.js → loot-system.js → enemy-types.js → arena-objectives.js → campaign-system.js → multiplayer.js → inline <script>
```
