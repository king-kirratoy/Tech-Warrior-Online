...
| `js/menus.js` | All menu and overlay logic: main menu, hangar nav, death screen, pause, loadout overlay, hover card system, inventory management, leaderboard, and game cleanup. `_renderGearBonusesPanel()` merges skill tree bonuses into gear bonuses display in campaign mode (v6.94); header shows "GEAR / SKILL BONUSES" in campaign, "GEAR BONUSES" otherwise. |
